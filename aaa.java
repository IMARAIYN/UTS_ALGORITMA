...
public class aaa {
    public static void main(String[] args) throws Exception{
        ArrayList<ccc> zakatList = new ArrayList<>();
        ...
        do {
            ...
            if (jenisZakat.equalsIgnoreCase("fitrah")) {
                ...
                ccc zakatFitri = new ccc(nama, alamat, jenisZakat, jumlahBeras, jumlahZakat);
                zakatList.add(zakatFitri);
            } else if (jenisZakat.equalsIgnoreCase("sedekah")) {
                double jumlahZakat = jumlahUang;

                ccc zakatFitri = new ccc(nama, alamat, jenisZakat, jumlahUang, jumlahZakat);
                zakatList.add(zakatFitri);
            }
